...
define('G5_MYSQL_HOST', 'db.koreanproducts.net');
define('G5_MYSQL_USER', 'hosan');
define('G5_MYSQL_PASSWORD', 'hosan1234!');
define('G5_MYSQL_DB', 'dbhosan');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'ko_g5_');
