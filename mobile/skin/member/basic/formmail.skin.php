...
<section class="contents">
    ...
    <li><a href="<?echo G5_URL?>/bbs/board.php?bo_table=notice">공지&뉴스</a></li>
        <li><a href="<?echo G5_URL?>/bbs/formmail.php" class="on">고객문의</a></li>
    </ul>
    <form name="fformmail" action="./formmail_send.php" onsubmit="return fformmail_submit(this);" method="post" enctype="multipart/form-data" style="margin:0px;">
        <input type="hidden" name="to" value="<?php echo $email ?>">
        <input type="hidden" name="attach" value="1">
        <input type="hidden" name="type" value="0" id="type_text">     
    <div class="txtTit">      
        <div class="pb32 ">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                    <input type="text" name="fnick" id="fnick" required class="mSize" placeholder="이름을 입력하세요." />
                    </td>
                </tr>
                <tr>
                    <th class="checkicright">연락처</th>
                    <td>
                        <input type="text" name="fphone" id="fphone" required placeholder="연락처를 입력하세요." class="mSize" />
                    </td>
                </tr>
                <tr>
                    <th class="checkicright">이메일</th>
                    <td>
                        <input type="email" name="fmail" id="fmail" required class="mSize" placeholder="이메일을 입력하세요." />
                    </td>
                </tr>
                <tr>
                    <th class="checkicright">제목</th>
                    <td>
                        <input type="text" name="subject" id="subject" required class="megaSize" placeholder="제목" />
                    </td>
                </tr>
                <tr>
                    <th class="checkicright">내용</th>
                    <td>
                        <textarea name="content" id="content" required class="megaSize" placeholder="내용"></textarea>
                    </td>
                </tr>
                <tr>
                    <th >첨부파일</th>
    ...
    <div class="btnArea">
        <button type="submit" id="btn_submit" class="btnL">문의보내기</button>
    </div>
    </form>    
</section>
	</article>
